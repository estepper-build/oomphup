 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Callout#getSnippet <em>Snippet</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getCallout()
 * @model
 * @generated
 */
public interface Callout extends BodyElementContainer
{
   ...
   * It is bidirectional and its opposite is '{@link org.eclipse.oomph.releng.doc.article.Snippet#getCallouts <em>Callouts</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getCallout_Snippet()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.oomph.releng.doc.article.Callout#getSnippet <em>Snippet</em>}' container reference.
