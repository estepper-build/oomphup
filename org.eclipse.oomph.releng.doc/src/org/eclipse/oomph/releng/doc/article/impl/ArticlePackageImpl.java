...
public class ArticlePackageImpl extends EPackageImpl implements ArticlePackage
{
   ...
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   *
   * <p>This method is used to initialize {@link ArticlePackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public EAttribute getTreeFormatter_ExpandTo()
  {
    return (EAttribute)treeFormatterEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getTreeFormatter_Expanded()
  {
    return (EAttribute)treeFormatterEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getTreeFormatter_Selected()
  {
    return (EAttribute)treeFormatterEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EAttribute getTreeNode_Image()
  {
   ...
   * @generated
   */
  public EClass getTreeNodeProperty()
  {
    return treeNodePropertyEClass;
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(treeFormatterEClass, TREE_FORMATTER__EXPAND_TO);
    createEAttribute(treeFormatterEClass, TREE_FORMATTER__EXPANDED);
    createEAttribute(treeFormatterEClass, TREE_FORMATTER__SELECTED);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getLinkTarget_DefaultLabel(), ecorePackage.getEString(), "defaultLabel", null, 0, 1, LinkTarget.class, IS_TRANSIENT, IS_VOLATILE,
        !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEAttribute(getLinkTarget_Tooltip(), ecorePackage.getEString(), "tooltip", null, 1, 1, LinkTarget.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEClass(externalArticleEClass, ExternalArticle.class, "ExternalArticle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getExternalArticle_Url(), ecorePackage.getEString(), "url", null, 1, 1, ExternalArticle.class, !IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE,
        !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getToc_Levels(), ecorePackage.getEInt(), "levels", "-1", 0, 1, Toc.class, !IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(pluginResourceEClass, PluginResource.class, "PluginResource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEAttribute(getTreeFormatter_Expanded(), ecorePackage.getEString(), "expanded", null, 0, -1, TreeFormatter.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTreeFormatter_Selected(), ecorePackage.getEString(), "selected", null, 0, 1, TreeFormatter.class, !IS_TRANSIENT, !IS_VOLATILE,
        IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getImageFactory_File(), getFile(), "file", null, 0, 1, ImageFactory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
