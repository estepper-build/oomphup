...
/**
 * This is the item provider adapter for a {@link org.eclipse.oomph.releng.doc.article.TreeFormatter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TreeFormatterItemProvider extends FormatterItemProvider
{
  /**
   ...
   * @generated
   */
  public TreeFormatterItemProvider(AdapterFactory adapterFactory)
  {
  ...
  /**
   * This returns TreeFormatter.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/TreeFormatter"));
  }
  ...
  {
    File labelValue = ((TreeFormatter)object).getFile();
    String label = labelValue == null ? null : labelValue.toString();
    return label == null || label.length() == 0 ? getString("_UI_TreeFormatter_type") : getString("_UI_TreeFormatter_type") + " " + label;
  }
