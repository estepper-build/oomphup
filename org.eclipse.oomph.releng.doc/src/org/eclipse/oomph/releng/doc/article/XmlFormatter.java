 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.XmlFormatter#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getXmlFormatter()
 * @model
 * @generated
 */
public interface XmlFormatter extends Formatter
{
   ...
   * @see #setFile(File)
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getXmlFormatter_File()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.oomph.releng.doc.article.XmlFormatter#getFile <em>File</em>}' attribute.
