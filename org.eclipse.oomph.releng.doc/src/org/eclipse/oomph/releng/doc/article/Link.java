 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Link#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getLink()
 * @model
 * @generated
 */
public interface Link extends BodyElement
{
   ...
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getLink_Target()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.oomph.releng.doc.article.Link#getTarget <em>Target</em>}' reference.
