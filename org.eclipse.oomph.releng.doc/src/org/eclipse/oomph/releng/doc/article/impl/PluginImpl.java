 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.PluginImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.PluginImpl#getPackages <em>Packages</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.PluginImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.PluginImpl#getExtensionPoints <em>Extension Points</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginImpl extends EObjectImpl implements Plugin
{
  ...
  public EList<JavaPackage> getPackages()
  {
    if (packages == null)
    {
      packages = new EObjectContainmentWithInverseEList<JavaPackage>(JavaPackage.class, this, ArticlePackage.PLUGIN__PACKAGES,
          ArticlePackage.JAVA_PACKAGE__PLUGIN);
    }
    return packages;
  }
  ...
  public EList<ExtensionPoint> getExtensionPoints()
  {
    ...
    {
      extensionPoints = new EObjectContainmentWithInverseEList<ExtensionPoint>(ExtensionPoint.class, this, ArticlePackage.PLUGIN__EXTENSION_POINTS,
