 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.DocumentationImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.DocumentationImpl#getEmbeddableElements <em>Embeddable Elements</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.DocumentationImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.DocumentationImpl#getProject <em>Project</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.DocumentationImpl#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentationImpl extends StructuralElementImpl implements Documentation
{
  ...
  public EList<Documentation> getDependencies()
  {
    ...
    {
      dependencies = new EObjectEList<Documentation>(Documentation.class, this, ArticlePackage.DOCUMENTATION__DEPENDENCIES);
    }
    return dependencies;
  }
