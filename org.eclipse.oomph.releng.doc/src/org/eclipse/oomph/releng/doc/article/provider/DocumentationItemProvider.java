...
/**
 * This is the item provider adapter for a {@link org.eclipse.oomph.releng.doc.article.Documentation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentationItemProvider extends StructuralElementItemProvider
{
  /**
  ...
  protected void addDependenciesPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Documentation_dependencies_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Documentation_dependencies_feature", "_UI_Documentation_type"),
        ArticlePackage.Literals.DOCUMENTATION__DEPENDENCIES, true, false, true, null, null, null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Documentation_project_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Documentation_project_feature", "_UI_Documentation_type"),
        ArticlePackage.Literals.DOCUMENTATION__PROJECT, false, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ArticlePackage.Literals.DOCUMENTATION__EMBEDDABLE_ELEMENTS);
      childrenFeatures.add(ArticlePackage.Literals.DOCUMENTATION__PLUGINS);
    }
