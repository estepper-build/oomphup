 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Documentation#getContext <em>Context</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Documentation#getEmbeddableElements <em>Embeddable Elements</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Documentation#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Documentation#getProject <em>Project</em>}</li>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.Documentation#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getDocumentation()
 * @model
 * @generated
 */
public interface Documentation extends StructuralElement
{
  ...
  /**
   * Sets the value of the '{@link org.eclipse.oomph.releng.doc.article.Documentation#getContext <em>Context</em>}' container reference.
   ...
   * type {@link org.eclipse.oomph.releng.doc.article.EmbeddableElement}. It is bidirectional and its opposite is '
   ...
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getDocumentation_Dependencies()
   ...
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getDocumentation_Project()
   ...
   * The list contents are of type {@link org.eclipse.oomph.releng.doc.article.Plugin}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.eclipse.oomph.releng.doc.article.ArticlePackage#getDocumentation_Plugins()
