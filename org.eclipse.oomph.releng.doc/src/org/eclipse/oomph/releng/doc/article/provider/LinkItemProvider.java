...
/**
 * This is the item provider adapter for a {@link org.eclipse.oomph.releng.doc.article.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider extends BodyElementItemProvider
{
  /**
  ...
  protected void addTargetPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        ArticlePackage.Literals.LINK__TARGET, true, false, true, null, null, null));
  }
  ...
  {
    Tag labelValue = ((Link)object).getTag();
    String label = labelValue == null ? null : labelValue.toString();
    return label == null || label.length() == 0 ? getString("_UI_Link_type") : getString("_UI_Link_type") + " " + label;
  }
