 ...
 * <ul>
 *   <li>{@link org.eclipse.oomph.releng.doc.article.impl.BodyElementContainerImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BodyElementContainerImpl extends EObjectImpl implements BodyElementContainer
{
  ...
  public EList<BodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentWithInverseEList<BodyElement>(BodyElement.class, this, ArticlePackage.BODY_ELEMENT_CONTAINER__ELEMENTS,
  ...
  private static void addElement(EList<BodyElement> elements, Tag tag)
  {
    ...
    {
      elements.add(new KeyImpl(tag));
    }
    else if (name.equals("@select"))
    {
      elements.add(new SelectionImpl(tag));
    }
