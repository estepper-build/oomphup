 ...
 *
 * @version $Rev: 90 $, $Date: 2012-03-02 21:00:49 +0100 (Fr, 02 Mrz 2012) $
 *
 */
public class APIviz {
    ...
    public static boolean validOptions(String[][] options, DocErrorReporter errorReporter) {
        ...
        for (String[] o: options) {
            ...
            if (OPTION_NO_SUBTYPES.equals(o[0])) {
              continue;
            }
            if (OPTION_WARNINGS_FILE.equals(o[0])) {
              continue;
            }
    ...
    public static int optionLength(String option) {
        ...
        if (OPTION_NO_SUBTYPES.equals(option)) {
          return 1;
        }
        
        if (OPTION_WARNINGS_FILE.equals(option)) {
          return 2;
        }
        ...
        if (option.equals(OPTION_HELP)) {
            ...
            System.out.println(OPTION_NO_SUBTYPES  + "               Do not show subtypes in the package diagram");
            System.out.println(OPTION_WARNINGS_FILE  + "               Record warnings about missing descriptions");
        ...
        if (!htmlFile.exists()) {
            ...
            for (;;) {
                ...
                if (idx > 0) {
                    ...
                    root.printNotice("File does not exist: " + htmlFile.getAbsolutePath());
                    return;
                }
